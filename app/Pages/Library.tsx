...
import { BookOpen, Search, Clock, Book } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-black max-w-2xl mx-auto">
                        Access digital resources, journals, and catalog search
                    </p>
                </motion.div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <div className="text-center py-12">
                        ...
                        <p className="text-black">Library portal integration is in progress.</p>
                    </div>
                </div>
            </div>
        </div>
